            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={[styles.gridContainer, styles.mb40]}>
                    <View style={styles.col6}>
                        ...
                        <Text style={styles.body1}>Commerchope</Text>
                        <Text style={styles.body1}>Sargodha, Pakistan</Text>
                        <Text style={styles.body1}>+92 303 5501602</Text>
                        <Text style={styles.body1}> info@nextstore.com</Text>
                    </View>
                    <View style={styles.col6}>
                        <Text style={[styles.overline, styles.mb8]}>Invoice to</Text>
                        <Text style={styles.body1}>{data?.user?.fullName}</Text>
                        <Text style={styles.body1}>{data?.user?.address}{data?.user?.zip}{data?.user?.city}{data?.user?.state}{data?.user?.country}</Text>
